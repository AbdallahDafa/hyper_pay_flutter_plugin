...
//    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "hyper_pay")
  ...
  override fun onDetachedFromEngine(binding: FlutterPlugin.FlutterPluginBinding) {
    Log.i("abdo_hyperpay", "HyperPayPlugin - onDetachedFromEngine")
//    channel.setMethodCallHandler(null)
  ...
  private fun setUpChannelHyperPayRecieverFromFlutter(messenger: BinaryMessenger){
    ...
    Log.i("abdo_hyperpay", "HyperPayPlugin - setUpChannelHyperPayRecieverFromFlutter() -  methodChannel: $methodChannel")
    methodChannel.setMethodCallHandler {
        call, result ->
      Log.i("abdo_hyperpay", "HyperPayPlugin - last_update: 2025-11-02 9:35")
      Log.i("abdo_hyperpay", "HyperPayPlugin - setUpChannelHyperPayRecieverFromFlutter() - result: $result")

      if (call.method.equals("fromFlutter")){
        Log.i("abdo_hyperpay", "HyperPayPlugin - setUpChannelHyperPayRecieverFromFlutter() - result: $result");
        Log.i("abdo_hyperpay", "HyperPayPlugin - setUpChannelHyperPayRecieverFromFlutter() - call.arguments: ${call.arguments}");
        ...
        if (arguments != null) {
          ...
          Log.i("abdo_hyperpay", "HyperPayPlugin - setUpChannelHyperPayRecieverFromFlutter() - parse checkoutId: $checkoutId")
          Log.i("abdo_hyperpay", "HyperPayPlugin - setUpChannelHyperPayRecieverFromFlutter() - parse amount: $amount")
          Log.i("abdo_hyperpay", "HyperPayPlugin - setUpChannelHyperPayRecieverFromFlutter() - parse isTest: $isTest")
          Log.i("abdo_hyperpay", "HyperPayPlugin - setUpChannelHyperPayRecieverFromFlutter() - parse brandName: $brandName")
          ...
          Log.i("abdo_hyperpay", "HyperPayPlugin - setUpChannelHyperPayFromFlutter() - request: $request")
    ...
    EventChannel(messenger, "com.hyperpay/listenFromNative").setStreamHandler(
      object : EventChannel.StreamHandler {
        override fun onListen(arguments: Any?, events: EventChannel.EventSink?) {
          ...
          Log.i("abdo_hyperpay", "HyperPayPlugin - setupChannelHyperPaySendToFlutter() - onListen - arguments: $arguments");

        }

        override fun onCancel(arguments: Any?) {
          HyperPayPlugin.eventSink = null
          Log.i("abdo_hyperpay", "HyperPayPlugin - setupChannelHyperPaySendToFlutter() - onCancel - arguments: $arguments");
        }
      }
    )
  }
